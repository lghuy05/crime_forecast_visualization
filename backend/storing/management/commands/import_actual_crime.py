...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            result = CrimeDataProcessor.import_actual_crime_csv(csv_file, source)
...
# management/commands/import_mlp_predictions.py
# management/commands/import_baseline_predictions.py
# ... similar structure for each prediction type
